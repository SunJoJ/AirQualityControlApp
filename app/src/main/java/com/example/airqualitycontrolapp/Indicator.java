...
public class Indicator extends View {
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        outerCircleRadius = typedArray.getDimension(R.styleable.Indicator_radius, 20f);
        int outerColor = typedArray.getColor(R.styleable.Indicator_outerColor, Color.GRAY);
        int middleColor = typedArray.getColor(R.styleable.Indicator_middleColor, Color.WHITE);
        int innerColor = typedArray.getColor(R.styleable.Indicator_innerColor, Color.RED);
